...
# To train (exp time: 1h on RTX 4090)
python run_experiment.py --mode train --experiment_name Dubins3D2D_human_predict_TV_MPC --dynamics_class Dubins3D2D_Human_predict_TV --tMax 1 --pretrain --pretrain_iters 1000 --num_epochs 120000 --counter_end 100000 --num_nl 512 --set_mode avoid --lr 3e-5 --num_iterative_refinement 10 --MPC_batch_size 3000 --num_MPC_batches 5 --num_MPC_data_samples 5000 --numpoints 10000 --use_wandb --wandb_project particle_deepreach --wandb_name Dubins3D2D_human_pred_TV_MPC --wandb_group Dubins3D2D_human_pred_MPC_TV_MPC --wandb_entity hyeontaesung-korea-advanced-institute-of-science-and-tec
