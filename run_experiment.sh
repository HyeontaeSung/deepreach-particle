...
############################################## Dubions4D Human system #########################################################
python run_experiment.py --mode train --experiment_name Dubins4D_Human_Worst --dynamics_class Dubins4D_Human_Worst --tMax 1.5 --pretrain --pretrain_iters 1000 --num_epochs 110000 --counter_end 100000 --num_nl 512 --set_mode avoid --lr 2e-5 --num_iterative_refinement 15 --num_MPC_batches 15 --num_MPC_data_samples 2500 --numpoints 30000 --use_wandb --wandb_project particle_deepreach --wandb_name Dubins4D_Human_Worst --wandb_group Dubins4D_Human_Worst --wandb_entity YOUR_WANDB_NAME --not_use_MPC

python run_experiment.py --mode train --experiment_name Dubins4D_Human_Predict_TV_MPC12 --dynamics_class Dubins4D_Human_Predict_TV --tMax 1.5 --pretrain --pretrain_iters 1000 --num_epochs 110000 --counter_end 100000 --num_nl 512 --set_mode avoid --lr 2e-5 --num_iterative_refinement 15 --num_MPC_batches 15 --num_MPC_data_samples 2500 --numpoints 30000 --use_wandb --wandb_project particle_deepreach --wandb_name Dubins4D_Human_Predict_TV_MPC12 --wandb_group Dubins4D_Human_Predict_TV_MPC12 --wandb_entity YOUR_WANDB_NAME
